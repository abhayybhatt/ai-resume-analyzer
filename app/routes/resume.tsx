...
// import setGState = OPS.setGState;
        ...
        <main className="!pt-0">
            ...
            <div className="flex flex-row max-lg:flex-col-reverse">
                <section className="feedback-section bg-[url('/images/bg-small.svg') bg-cover h-[100vh] sticky top-0 items-center justify-center">
                    {imageUrl && resumeUrl && (
                        <div className="animate-in fade-in duration-1000 gradiet max-sm:m-0 h-[90%] max-2xl:h-fit w-fit">
                ...
                <section className="feedback-section">
                    <h2 className="text-4xl !text-bold font-bold">Resume Review</h2>
                    {feedback ? (
